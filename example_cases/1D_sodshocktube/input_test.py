...
# mfc_dir = '/ccsopen/home/mrdz/MFC-develop/src'; path[:0] = [mfc_dir + '/master_scripts']
mfc_dir = '/gpfs/wolf/gen159/proj-shared/MFC/spencer/MFC-develop/src'; path[:0] = [mfc_dir + '/master_scripts']
