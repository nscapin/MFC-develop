...
mpirun -n 5 ../../src/pre_process_code/pre_process
# time mpirun -n 5 ../../src/simulation_code/simulation

mpirun -n 5 nsys profile -o output-sys.prof --stats=true -t openacc,nvtx  --force-overwrite true ../../src/simulation_code/simulation
