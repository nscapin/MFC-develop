...
# jsrun -r1 -a1 -c1 -g1 ncu --kernel-regex s_weno_alt_177_gpu --launch-skip 3 --launch-count 1 --set full -o output.prof -f  ../../src/simulation_code/simulation

# jsrun -r1 -a1 -c1 -g1 ncu --launch-skip 4 --launch-count 2 --set full -o output.prof -f  ../../src/simulation_code/simulation


# jsrun -r1 -a1 -c1 -g1 nsys profile -o output-sys.prof --stats=true -t openacc  --force-overwrite true ../../src/simulation_code/simulation
